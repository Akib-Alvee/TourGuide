...
import secrets
from .models import *
from TourGuide.utils import render_to_pdf, createticket
...
def flight(request):
    ...
    return_date = None
    print(o_place, d_place, trip_type, depart_date)
    if trip_type == '2':
...
def payment(request):
    if request.user.is_authenticated:
        if request.method == 'POST':
            ...
            fare = 5432
            print(fare, card_number, card_holder_name, exp_month, exp_year, cvv)
